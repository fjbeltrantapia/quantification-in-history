...
Below you can find a curated set of varied historical datasets that you can use for the class assignment and your own research projects. Please make sure to read the original article describing the information. Digitising historical sources constitutes a huge effort, so we should especially thanks (and properly acknowledge) those authors who make their datasets public. Feel free to contact me if you want to use one of these sources for your project.  
